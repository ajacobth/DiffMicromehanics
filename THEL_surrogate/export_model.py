"""export_model.py – package a trained thermoelastic surrogate for deployment in final/.

Run this after training to update the artifacts in final/models/thermoelastic/:
...
Usage
-----
    python export_model.py --config configs/case_4.py --workdir . --out ../final/models/thermoelastic
"""
...
flags.DEFINE_string(
    "out", default="../final/models/thermoelastic",
    help="Destination directory (inside final/models/)",
)
config_flags.DEFINE_config_file(
    "config", default="./configs/case_4.py", lock_config=True,
)

INPUT_FIELD_NAMES = [
    "e1", "e2", "g12", "f_nu12", "f_nu23", "f_cte1", "f_cte2",
    "ar", "fiber_massfrac", "fiber_density",
    "matrix_modulus", "matrix_poisson", "matrix_density", "m_cte",
    "a11", "a22", "a12", "a13", "a23",
]
OUTPUT_FIELD_NAMES = [
...
def main(_argv):
    ...
    print(f"\nDone. Thermoelastic surrogate artifacts written to:\n  {out_dir}")
