...
# -*- coding: utf-8 -*-
"""
micro_surrogate.py – MICRO_SURROGATE class definitions.

Extends the base SURROGATE from NN_surrogate with composite-micromechanics-
specific loss functions (MSE, L2-regularised MSE, BNN variational).
"""
