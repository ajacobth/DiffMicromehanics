"""inverse_model.py – bounded Adam / L-BFGS / L-BFGS-B
...
* Casts optimisation variables to **float64** while keeping the NN in
  float32 → avoids XLA triangular_solve bug seen on some builds.
"""
...
def _lbfgs_box(fwd, prob, init64, lo64, hi64, **kw):
    ...
    for args in (
        ...
        try:
            ...
            continue
    raise TypeError("LBFGSB signature not recognised; upgrade jaxopt ≥0.6")
