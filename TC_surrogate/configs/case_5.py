...
def get_config():
    ...
    wandb.name    = "case_1_1e-5reg"
    wandb.tag     = None

    config.arch = arch = ml_collections.ConfigDict()
    arch.arch_name  = "Mlp"
    arch.hidden_dim = (128, 512, 256, 256, 128, 64, 16)#(128, 512, 256, 256, 128, 64, 16)
    ...
    weighting.init_weights = ml_collections.ConfigDict({"mse": 1., "l2": 1e-5})#1e-6})
