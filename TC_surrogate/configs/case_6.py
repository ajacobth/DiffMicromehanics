...
def get_config():
    ...
    arch.arch_name  = "Mlp"
    arch.hidden_dim = (128, 256, 512, 256, 256, 128, 64, 16)
    ...
    it.aspect_ratio = 18.0    # average fiber aspect ratio
    it.vf           = 0.25   # fiber volume fraction (~25 wt% CF in PESU)
    it.rho_f        = 1800.0  # fiber density  [kg/m³]
    it.rho_m        = 1250.0  # matrix density [kg/m³]
