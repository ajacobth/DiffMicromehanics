"""export_model.py – package a trained thermal conductivity surrogate for deployment in final/.

Run this after training to update the artifacts in final/models/thermal/:
...
Usage
-----
    python export_model.py --config configs/case_6.py --workdir . --out ../final/models/thermal
"""
...
flags.DEFINE_string(
    "out", default="../final/models/thermal",
    help="Destination directory (inside final/models/)",
)
config_flags.DEFINE_config_file(
    "config", default="./configs/case_6.py", lock_config=True,
)
...
def main(_argv):
    ...
    # 1. model_config.json
    model_config = {
        "_note": f"Generated from TC_surrogate {cfg.wandb.name}.",
    ...
    print(f"\nDone. Thermal surrogate artifacts written to:\n  {out_dir}")
